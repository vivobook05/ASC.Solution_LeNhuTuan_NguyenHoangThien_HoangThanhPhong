        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PartitionKey = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RowKey = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MasterDataKeyId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Value = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MasterDataKeyPartitionKey = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MasterDataKeyRowKey = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MasterDataValues_MasterDataKeys_MasterDataKeyPartitionKey_MasterDataKeyRowKey",
                        columns: x => new { x.MasterDataKeyPartitionKey, x.MasterDataKeyRowKey },
                        principalTable: "MasterDataKeys",
                        principalColumns: new[] { "PartitionKey", "RowKey" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MasterDataValues_MasterDataKeyPartitionKey_MasterDataKeyRowKey",
                table: "MasterDataValues",
                columns: new[] { "MasterDataKeyPartitionKey", "MasterDataKeyRowKey" });
        }
